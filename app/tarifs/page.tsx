    ...
    <main className={styles.main}>
      ...
      <section className={styles.zonesExplain}>
        ...
        <div className={styles.zonesCta}>
          <a href="/tarifs#reservation" className={styles.ctaInline}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.activitiesGrid}>
          <div className={styles.activityCard}>
            ...
            <a href="/tarifs#reservation" className={styles.activityCta}>Réserver un terrain →</a>
          </div>
          <div className={`${styles.activityCard} ${styles.activityCardFeatured}`}>
            ...
            <a href="/tarifs#reservation" className={`${styles.activityCta} ${styles.activityCtaGold}`}>Réserver une session →</a>
          </div>
          <div className={styles.activityCard}>
            ...
            <a href="/tarifs#reservation" className={styles.activityCta}>Réserver une table →</a>
          </div>
        </div>
      </section>
